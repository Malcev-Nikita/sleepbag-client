...
export default function Categories({data}) {
    ...
    const renderCategory = (category) => {
        ...
        if(isLargeScreen) {
            return (
                <button key={category.id} data-category-slug={category.attributes.slug} onClick={() => dispatch(categoryChange(category.attributes.slug))} className='catalog_category'>
            ...
            return (
                <div className="catalog_category_mobile">
                    ...
                    <button key={category.id} data-category-slug={category.attributes.slug} onClick={() => dispatch(categoryChange(category.attributes.slug))} className='w-[100%] flex items-center gap-[8px] py-[15px]'>

...
export default function Page() {
    return (
        <main className="container m-auto">
            ...
            <section className='userpage_info mobile_none pt-[160px]'>
                ...
                <div className='info_right w-[60%]'>
                    ...
                    <input className='focus:outline-none text-right' id='EMAIL' name='EMAIL' placeholder='E-mail' />
                    ...
                    <p>Имя</p>
                    <input className='focus:outline-none text-right ' id="NAME" name='NAME' placeholder='Имя' />
                    ...
                    <p>Фамилия</p>
                    <input className='focus:outline-none text-right' id='FIRST_NAME' name="FIRST_NAME" placeholder='Фамилия' />
                    ...
                    <p>Телефон</p>
                    <input className='focus:outline-none text-right' id='PHONE' name='PHONE' placeholder='Телефон' />
                    ...
                    <p>Пароль</p>
                    <input className='focus:outline-none text-right' id='PASSWORD' name='PASSWORD' placeholder='Пароль' />
            ...
            <article className='link_path mobile_block pt-[30px] flex flex-row justify-between'>
                <a href='/' className='text-[#000] opacity-70'>Главная / </a><span>Личный кабинет</span>
                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg"><g opacity="0.5"><path d="M12.3145 3.39977C12.9665 2.69332 13.2925 2.3401 13.639 2.13406C14.4749 1.63691 15.5042 1.62145 16.3541 2.09328C16.7063 2.28882 17.0423 2.63211 17.7144 3.31867C18.3865 4.00523 18.7225 4.34851 18.914 4.70831C19.3758 5.57648 19.3607 6.62794 18.874 7.48187C18.6723 7.83576 18.3266 8.1688 17.635 8.83488L9.4068 16.76C8.09627 18.0223 7.441 18.6534 6.62205 18.9733C5.80311 19.2931 4.9028 19.2696 3.10219 19.2225L2.85721 19.2161C2.30904 19.2018 2.03496 19.1946 1.87564 19.0138C1.71631 18.833 1.73807 18.5538 1.78157 17.9954L1.80519 17.6922C1.92763 16.1206 1.98885 15.3348 2.29574 14.6284C2.60264 13.9221 3.13201 13.3485 4.19075 12.2014L12.3145 3.39977Z" stroke="#707070" stroke-width="1.5" stroke-linejoin="round"/><path d="M11.375 3.5L17.5 9.625" stroke="#707070" stroke-width="1.5" stroke-linejoin="round"/><path d="M12.25 19.25L19.25 19.25" stroke="#707070" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></g></svg>
            </article>

            <section className='userpage_info mobile_block pt-[30px] flex flex-col'>
                <div className='info_left bg-[#f4f4f4] rounded flex justify-center items-center w-[30%]'>
                    <svg width="237" height="295" viewBox="0 0 237 295" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M204.706 85.9875C204.706 131.82 166.003 168.975 118.26 168.975C70.518 168.975 31.8151 131.82 31.8151 85.9875C31.8151 40.1548 70.518 3 118.26 3C166.003 3 204.706 40.1548 204.706 85.9875Z" fill="#DFDFDF"/>
                        <path d="M118.26 168.975C166.003 168.975 204.706 131.82 204.706 85.9875C204.706 40.1548 166.003 3 118.26 3C70.518 3 31.8151 40.1548 31.8151 85.9875C31.8151 131.82 70.518 168.975 118.26 168.975ZM118.26 168.975C3 168.975 3 218.515 3 279.625M118.26 168.975C233.521 171.38 233.521 218.515 233.521 279.625" stroke="#DFDFDF" stroke-width="5" stroke-linecap="round"/>
                ...
                <div className='info_right w-[60%]'>
                    ...
                    <label for="EMAIL" className='info_right_block relative flex justify-between text-[21px] font-medium items-center h-[80px] font-[Manrope] px-[5px]'>
                        <p>Адрес электронной почты</p>
                        <input className='focus:outline-none text-right text-[#F97316]' id='EMAIL' name='EMAIL' placeholder='E-mail' />
                    </label>
                    ...
                    <label for="NAME" className='info_right_block relative flex justify-between text-[21px] font-medium items-center h-[80px] font-[Manrope] px-[5px]'>
                        <p>Имя</p>
                        <input className='focus:outline-none text-right text-[#F97316]' id="NAME" name='NAME' placeholder='Имя' />
                    </label>
                    ...
                    <label for="FIRST_NAME" className='info_right_block relative flex justify-between text-[21px] font-medium items-center h-[80px] font-[Manrope] px-[5px]'>
                        <p>Фамилия</p>
                        <input className='focus:outline-none text-right text-[#F97316]' id='FIRST_NAME' name="FIRST_NAME" placeholder='Фамилия' />
                    </label>
                    ...
                    <label for="PHONE" className='info_right_block relative flex justify-between text-[21px] font-medium items-center h-[80px] font-[Manrope] px-[5px]'>
                        <p>Телефон</p>
                        <input className='focus:outline-none text-right text-[#F97316]' id='PHONE' name='PHONE' placeholder='Телефон' />
                    </label>
                    ...
                    <label for="PASSWORD" className='info_right_block relative flex justify-between text-[21px] font-medium items-center h-[80px] font-[Manrope] px-[5px]'>
                        <p>Пароль</p>
                        <input className='focus:outline-none text-right text-[#F97316]' id='PASSWORD' name='PASSWORD' placeholder='Пароль' />
                    </label>
            ...
            <section className='userpage_blocks mobile_block pb-[60px] flex flex-col'>

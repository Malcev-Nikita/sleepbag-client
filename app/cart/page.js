    ...
    <main className="container m-auto">
        ...
        <section className='m-0 pt-[33px] w-[100%] flex flex-col'>
          ...
          <div className='flex flex-row'>
            <h2 className='text-2xl font-[Unbounded] font-bold'>КОРЗИНА</h2><p>(Количество товаров в корзине)</p>
          </div>
          ...
          <article className='items-right text-right'>
            ...
            <p className='text-[30px] mt-[16px] text-[#f97316] font-semibold'>Итого: 30 000 ₽</p>
          ...
          {/* <tabel>
              ...
              <thead>
                <tr>
                  <label><th scope='col'><input type="checkbox"></input> Выбрать всё</th></label>
              ...
              <tbody>
                <tr>
                  ...
                  <th scope='row'><input type="checkbox"></input> Фото товара</th>
                  ...
                  <td className='flex flex-row gap-[5px]'>
                    <button>-</button>
                    <p>1</p>
                    <button>+</button>
                  </td>
                  ...
                  <td className='flex flex-col'>
                    ...
                    <div className='flex flex-row gap-[22px]'>
                      ...
                      <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1 8.625C1 4.04167 4.64583 3 6.72917 3C9.33333 3 11.4167 5.08333 12.4583 6.64583C13.5 5.08333 15.5833 3 18.1875 3C20.2708 3 23.9167 4.04167 23.9167 8.625C23.9167 15.5 12.4583 21.75 12.4583 21.75C12.4583 21.75 1 15.5 1 8.625Z" stroke="#333333" stroke-width="1.5"/>
                      </svg>
